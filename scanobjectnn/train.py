...
def main(cfg):
    torch.cuda.set_device(cfg.decive)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--add_info", type=str, required=True, default='test')
    parser.add_argument("--decive", type=int, required=False, default=0)
